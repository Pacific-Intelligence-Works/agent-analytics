        ...
        <div className="px-6 py-4">
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                onClick={enableAll}
                className="rounded px-2 py-1 text-xs text-brand-600 transition-colors hover:bg-gray-100"
              >
                Enable all
              </button>
              <button
                  ...
                  {agents.map((agent) => (
                    ...
                    >
                      <input
                        ...
                        className="mt-0.5 h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-600 focus:ring-offset-0"
                      />

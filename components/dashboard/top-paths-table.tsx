...
export function TopPathsTable({ paths, accountId, days }: TopPathsTableProps) {
  ...
  if (filtered.length === 0) {
    return (
      <div className="flex h-32 items-center justify-center rounded-xl border border-gray-800 bg-gray-900/50">
        <p className="text-sm text-gray-500">No path data yet</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex max-h-[400px] flex-col rounded-xl border border-gray-800 bg-gray-900/50">

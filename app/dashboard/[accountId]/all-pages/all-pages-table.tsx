      ...
      <div className="border-b border-gray-200 p-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-200 bg-white py-2 pl-10 pr-4 text-sm text-gray-900 placeholder-gray-400 outline-none transition-colors focus:border-brand-600 focus:ring-1 focus:ring-brand-600"
          />
        </div>
      </div>

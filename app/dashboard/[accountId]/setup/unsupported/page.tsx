    ...
    return (
      ...
      >
        <div className="flex items-start gap-3 rounded-lg border border-green-900/50 bg-green-950/30 p-4">
          ...
          <div>
            <p className="font-medium text-green-300">Request recorded</p>
        ...
        <button
          ...
          className="mt-6 rounded-lg border border-gray-700 px-4 py-2.5 text-sm font-medium text-gray-300 transition-colors hover:bg-gray-800"
        >
          Back to dashboard
        </button>
      </SetupShell>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-700 bg-gray-800 px-4 py-2.5 text-sm text-white placeholder-gray-500 outline-none transition-colors focus:border-indigo-500"
          />
        </div>

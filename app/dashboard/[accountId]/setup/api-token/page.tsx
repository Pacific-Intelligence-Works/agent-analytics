...
export default function ApiTokenPage({
  ...
  return (
    ...
    >
      <div className="mb-6 flex items-start gap-3 rounded-lg border border-gray-800 bg-gray-900 p-4">
        ...
        <div className="text-sm text-gray-400">
          ...
          <ol className="list-inside list-decimal space-y-1.5">
            ...
            <li>
              Click{" "}
              <span className="font-medium text-gray-300">Create Token</span>{" "}
              &rarr;{" "}
              <span className="font-medium text-gray-300">Custom token</span>
            </li>
            <li>
              Set permission:{" "}
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="relative">
          <input
            ...
            className="mb-2 w-full rounded-lg border border-gray-700 bg-gray-800 px-4 py-2.5 pr-10 font-mono text-sm text-white placeholder-gray-500 outline-none transition-colors focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
          />
          <button
            type="button"
